...
class ConsultationControllerTest {
	...
	CreateConsultationRequest ccrobject = new CreateConsultationRequest();
	ccrobject.getCreateConsultationRequest(testRequest);
    ...
    public CreateConsultationRequest getCreateConsultationRequest(TestRequest testRequest) {
        ...
        // Return the object
	CreateLabResult clrobj= new CreateLabresult();
